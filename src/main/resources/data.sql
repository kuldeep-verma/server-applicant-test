...
INSERT INTO car(id, license_plate, engine_type, color, seat_count, convertible, manufacturer, deleted, date_created)
VALUES(1, 'KV 001', 'Gas', 'Black', 5, true, 1, false, now());

INSERT INTO car(id, license_plate, engine_type, color, seat_count, convertible, manufacturer, deleted, date_created)
VALUES(2, 'KV 010', 'Electric', 'White', 5, false, 1, false, now());

INSERT INTO car(id, license_plate, engine_type, color, seat_count, convertible, manufacturer, deleted, date_created)
VALUES(3, 'KV 100', 'Gas', 'Red', 5, true, 1, false, now());

INSERT INTO car(id, license_plate, engine_type, color, seat_count, convertible, manufacturer, deleted, date_created)
VALUES(4, 'KV 999', 'Electric', 'Blue', 7, false, 2, false, now());
